...
// Legacy colors compatibility (optional, mapping to new colors)
val Primary = md_theme_light_primary
val PrimaryVariant = md_theme_light_primaryContainer
...
val OnPrimary = md_theme_light_onPrimary
val OnSecondary = md_theme_light_onSecondary
